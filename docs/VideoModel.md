...
| **description** | **kotlin.String** | The description of the video |  [optional] |
...
| **status** | [**net.bunny.api.model.VideoModelStatus**](net.bunny.api.model.VideoModelStatus.md) | The status of the video. See VideoModelStatus. |  [optional] |
...
| **thumbnailBlurhash** | **kotlin.String** | Thumbnail blurhash to show while the actual thumbnail is being loaded |  [optional] |
...
| **jitEncodingEnabled** | **kotlin.Boolean** |  |  [optional] |
| **smartGenerateStatus** | [**net.bunny.api.model.SmartGenerateStatus**](net.bunny.api.model.SmartGenerateStatus.md) | Aggregate smart generate status derived from per-feature statuses when present: InProgress, then Queued, then Failed, then Finished; otherwise the stored legacy value. See SmartGenerateFeaturesStatus. |  [optional] |
| **smartGenerateFeaturesStatus** | [**SmartGenerateFeaturesStatusModel**](SmartGenerateFeaturesStatusModel.md) | Per-feature smart generate statuses (title, description, chapters, moments). Null for a feature on legacy rows. |  [optional] |
| **hasOriginal** | **kotlin.Boolean** | Determines if video has the original file available in storage |  [optional] |
| **originalHash** | **kotlin.String** | Original uploaded file SHA256 hash |  [optional] |
| **hasHighQualityPreview** | **kotlin.Boolean** |  |  [optional] |
