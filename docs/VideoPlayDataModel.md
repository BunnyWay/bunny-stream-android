...
**libraryName** | **kotlin.String** |  |  [optional]
...
**viAiPublisherId** | **kotlin.String** |  |  [optional]
...
**widevineMinClientSecurityLevel** | **kotlin.Int** |  |  [optional]
**zoneTier** | **kotlin.Int** |  |  [optional]
**isPlayable** | **kotlin.Boolean** | Determines if the video is currently playable using either playlist or original source. |  [optional]
**isPlaylistPlayable** | **kotlin.Boolean** | Determines if the HLS playlist is currently playable. |  [optional]
**preferredPlaybackSource** | [**net.bunny.api.model.VideoPlaybackSource**](VideoPlayDataModelPreferredPlaybackSource.md) |  |  [optional]
**rememberPlayerPosition** | **kotlin.Boolean** |  |  [optional]
**customCss** | **kotlin.String** |  |  [optional]
**exposeVideoMetadata** | **kotlin.Boolean** |  |  [optional]
**enableCompactControls** | **kotlin.Boolean** |  |  [optional]
